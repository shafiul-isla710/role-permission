                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('product.store') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="number" class="form-control @error('price') is-invalid @enderror" id="price" name="price" value=""
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="number" class="form-control @error('qty') is-invalid @enderror" id="quantity" name="qty" value=""
